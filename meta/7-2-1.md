...
computation_calculations: <p>Monthly data on electric power generation are annualized
  ...
  and the one published in the <a href="https://energy-information.canada.ca/en/energy-facts/clean-power-low-carbon-fuels">Energy
...
comments_limitations: <p>Please note the following reason for the difference in the
  ...
  in the <a 
  href="https://energy-information.canada.ca/en/energy-facts/clean-power-low-carbon-fuels">Energy
