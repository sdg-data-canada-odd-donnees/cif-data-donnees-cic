...
comments_limitations: <p>During the production of each year's crime statistics, data
  ...
  received from the police services.</p><p>The total line "Total violent Criminal
  Code violations" aggregates the selected types of crime reported in the chart above,
  as well as a few violation types not reported in the chart. See source table for
