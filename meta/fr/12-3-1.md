...
comments_limitations: "Ces donnés ne portent que sur les entreprises et les organisations locales de gestion des déchets qui ont déclaré des activités liées à la 
...
les déchets qui pourraient être gérés sur place par les entreprises ou les ménages. De plus, ces données n'incluent pas les matières transportées par le producteur 
